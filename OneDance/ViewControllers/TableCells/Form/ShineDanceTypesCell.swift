//
//  ShineDanceTypesCell.swift
//  OneDance
//
//  Created by Burak Can on 3/18/18.
//  Copyright © 2018 Burak Can. All rights reserved.
//

import UIKit

class ShineDanceTypesCell: BaseFormCell {
    ...
    fileprivate func setup(){
        ...
        let collView = UICollectionView(frame: CGRect(), collectionViewLayout: self.flowLayout)
        self.collectionView = collView
        
        let views = [leftLabel, rightLabel, contentContainer, seperator, datePickerContainer, collectionView]
        for view in views {
        ...
        datePickerContainer.addSubview(collectionView)
    ...
    override public init(style: UITableViewCellStyle, reuseIdentifier: String?) {
        super.init(style: style, reuseIdentifier: ShineDanceTypesCell.identifier)
